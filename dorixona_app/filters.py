...
class FirmaSavdolariFilter(django_filters.FilterSet):
    ...
    date = django_filters.DateFilter(field_name='harid_sanasi', lookup_expr='date')
    from_date = django_filters.DateFilter(field_name='harid_sanasi', lookup_expr='date__gte')
    to_date = django_filters.DateFilter(field_name='harid_sanasi', lookup_expr='date__lte')
